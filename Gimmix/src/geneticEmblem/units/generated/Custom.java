...
public class Custom extends Unit {
		...
		public Custom(Weapon newWeapon, int baseHP, int baseCrit, int strBase, int skillBase, int speedBase, int luckBase, int
				defBase, int resBase, int hpGr, int strGr, int skillGr, int speedGr, int luckGr, int defGr, int resGr, int
				strCap, int speedCap, int skillCap, int defCap, int resCap) {
			this.setJob("Custom");
